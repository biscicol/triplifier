...
function defineHelpMessages(helpmgr) {
	...
	'<p>If your identifiers are not guaranteed to be unique, then you should leave this checkbox unchecked.  In this case, the Triplifier will use the table name to construct a unique identifier for each row of the data.  If you are unsure, leave the box unchecked.</p>');
	// Attributes.
